...
class GameInfo:
    def __init__(self):
        ...
        self.SecretKey: str = "sekey"
        self.ApiKey: str = "apikey"
        self.PlayfabAuthenticationWebhook: str = "webhook_url"
        self.QuestsWebhook: str = "webhook_url"
        self.PhotonWebhook: str = "webhook_url"
...
ALLOWED_PACKAGE_IDS = ["com.DaveeStudios.DreamTag"]   # replace with your app's package id
